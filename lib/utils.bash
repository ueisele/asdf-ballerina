...
GH_REPO="https://github.com/ballerina-platform/ballerina-distribution"
TOOL_CMD="bal"
...
download_release() {
	...
	url="$GH_REPO/releases/download/v${version}/ballerina-${version}-swan-lake.zip"
